...
namespace SpawnCreator
{
    public partial class QuestTemplate : Form
    {
        ...
        public void DeleteQuest()
        {
            ...
            try
            {
                ...
                _command.CommandText = $"DELETE FROM { form_MM.GetWorldDB() }.quest_template WHERE ID=@ID; " +
                                       ...
                                       $"DELETE FROM { form_MM.GetWorldDB() }.gameobject_queststarter WHERE quest=@Quest; " +
                                       $"DELETE FROM { form_MM.GetWorldDB() }.gameobject_questender WHERE quest=@Quest;";
        ...
        private void QuestTemplate_Load(object sender, EventArgs e)
        {
            ...
            CB_Choose_npc_or_go.SelectedIndex = 0; // Creature Quest
        ...
        private void GenerateSqlCode(object sender, EventArgs e)
        {
            ...
            if (CB_Choose_npc_or_go.SelectedIndex == 0) // Creature Quest
            {
            ...
            else // GameObject Quest
            {
                //GameObject Quest Starter
                BuildSQLFile += textBox105.Text + " INTO " + form_MM.GetWorldDB() + ".gameobject_queststarter ";
                BuildSQLFile += "(id, quest) ";
                BuildSQLFile += "VALUES " + Environment.NewLine;
                BuildSQLFile += "(";
                BuildSQLFile += textBox106.Text + ", "; // GameObject Entry
                BuildSQLFile += textBox107.Text; // Quest ID
                BuildSQLFile += "); " + Environment.NewLine;

                //GameObject Quest Ender
                BuildSQLFile += textBox105.Text + " INTO " + form_MM.GetWorldDB() + ".gameobject_questender ";
                BuildSQLFile += "(id, quest) ";
                BuildSQLFile += "VALUES " + Environment.NewLine;
                BuildSQLFile += "(";
                BuildSQLFile += textBox109.Text + ", "; // GameObject Entry
                BuildSQLFile += textBox108.Text; // Quest ID
                BuildSQLFile += "); ";
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (CB_Choose_npc_or_go.SelectedIndex == 0)
            {
                if (textBox106.Text == "")
                {
                    MessageBox.Show("Creature Quest Starter Entry should not be empty", "Error");
            ...
            else
            {
                if (textBox106.Text == "")
                {
                    MessageBox.Show("GameObject Quest Starter Entry should not be empty", "Error");
                    return;
                }
                if (textBox109.Text == "")
                {
                    MessageBox.Show("GameObject Quest Ender Entry should not be empty", "Error");
                    return;
                }
            }
        ...
        private void CB_Choose_npc_or_go_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (CB_Choose_npc_or_go.SelectedIndex == 0)
            {
                label87.Text = "Creature Entry";
                label118.Text = "Creature Entry";
                groupBox6.Text = "Creature Quest Starter";
                groupBox7.Text = "Creature Quest Ender";
            }
            else
            {
                label87.Text = "GameObject Entry";
                label118.Text = "GameObject Entry";
                groupBox6.Text = "GameObject Quest Starter";
                groupBox7.Text = "GameObject Quest Ender";
            }
        }

        private void textBox106_TextChanged(object sender, EventArgs e)
        {
            textBox109.Text = textBox106.Text;
        }
    }
}
