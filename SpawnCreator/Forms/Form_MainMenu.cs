    ...
    public partial class Form_MainMenu : Form
    {
      ...
      //+++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        private void button_mysql_connect_Click(object sender, EventArgs e)
        {
            ...
            string myConnection =
                $"Server={ textbox_mysql_hostname.Text };Port={ textbox_mysql_port.Text };Uid={ textbox_mysql_username.Text };Pwd={ textbox_mysql_pass.Text };";
            ...
            try
            {
                ...
                {
                    if (ex.Number == 0)
                        MessageBox.Show(ex.Message + "\n\nPossibly invalid username/password, please try again.", "SpawnCreator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    else
                        MessageBox.Show($"Error No. { ex.Number }: \n{ ex.Message }", "SpawnCreator", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                // If everything is OK show all buttons (to create item,npc,go... etc)
        ...
        private void button_fill_default_Click(object sender, EventArgs e)
        {
            ...
            textbox_mysql_pass.Text     = "ascent";
        }
        ...
        private void button_mysql_connect_MouseEnter(object sender, EventArgs e)
        {
            button_mysql_connect.ForeColor = Color.Aquamarine;
        }

        private void button_mysql_connect_MouseLeave(object sender, EventArgs e)
        {
            button_mysql_connect.ForeColor = Color.White;
        }
    }
}
